...
use App\Http\Controllers\ChungProc7Controller;
use App\Http\Controllers\ChungProc8Controller;
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/ChungProc7', [ChungProc7Controller::class, 'index'])->name('ChungProc7.index');
    Route::get('/ChungProc8', [ChungProc8Controller::class, 'index'])->name('ChungProc8.index');
