		...
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					...
					<div class="col-sm-6">
						<a href="{{ route('home') }}" class="btn btn-secondary"><i class="fa fa-home"></i> Trang Chủ</a>
						<a href="{{ route('chitietphieu.create') }}" class="btn btn-success"><i class="fa fa-plus"></i> Thêm Mới</a>
					</div>
				</div>
			</div>
